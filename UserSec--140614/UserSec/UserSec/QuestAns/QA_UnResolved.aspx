<%@ Page Title="&#956Lessons - UnResolved" Language="C#" MasterPageFile="~/UserMaint/LoggedIn.Master"
    AutoEventWireup="true" CodeBehind="QA_UnResolved.aspx.cs" Inherits="UserSec.QuestAns.QA_UnResolved" %>
        ...
        <div id="container" style="padding-top: 50px; background: none">
            <div id="Div1" class="pagination clearfix" runat="server">
                ...
                <div class="right">
                    ...
                    <tr>
                        <td>
                            <asp:DataPager runat="server" ID="QuickSearchDataPager" PageSize="10" PagedControlID="lvQuestList">
                                <Fields>
                ...
                <asp:ListView ID="lvQuestList" runat="server" ItemPlaceholderID="layoutTemplate"
                    ...
                    <div>
                        <tr class="row" id="trItemTemplate" runat="server">
                            ...
                            <td>
                                 <asp:LinkButton ID="Subject1" runat="server" CommandName="Edit" 
                            ...
                            <td>
                                <asp:LinkButton ID="Tags" runat="server" CommandName="Edit" 
                                CausesValidation="false" CommandArgument='<%# Eval("QId")%>' 
                                CssClass="dummyContainClass" >
                                <%# Eval("Tags")%>
                            </asp:LinkButton>
                            ...
                            <%--<td id="Td1" runat="server">
                                ...
                                <asp:LinkButton ID="btnEdit" runat="server" CommandName="Edit" CausesValidation="false"
                                    ToolTip="View" Text="View" CssClass="dummyContainClass" CommandArgument='<%# Eval("QId")%>' />
                            </td>--%>
                        </tr>
                    </div>
                </ItemTemplate>
