...
<script src="~/QuestAns/flowplayer-3.2.12.min.js" type="text/javascript"></script>
<script type="text/javascript">
    flowplayer("a.player", "~/QuestAns/flowplayer-3.2.16.swf", {
        plugins: {
            pseudo: { url: "~/QuestAns/flowplayer.pseudostreaming-3.2.12.swf" }
        },
        ...
        <asp:Button ID="btnClose" runat="server" Text="Close" />
         ...
         <td>     
           ...
           <asp:FileUpload ID="FileUpload1" runat="server" />
             ...
             <%-- <asp:Repeater ID="rptrUserVideo" runat="server">--%>
